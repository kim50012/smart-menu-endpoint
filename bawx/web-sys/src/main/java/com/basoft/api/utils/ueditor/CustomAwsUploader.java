 ...
 * @since 20190604
 */
public class CustomAwsUploader {
    ...
    public CustomAwsUploader(HttpServletRequest request, Map<String, Object> conf,
                             MultipartFile file, AwsFileUtil awsFileUtil) {
    ...
    private final State save() {
        ...
        result = awsFileUtil.uploadFile(request, file);
