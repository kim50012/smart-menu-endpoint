...
public class RedisUtil {
    ...
    public static final String TOKEN_SESSION  = "BAWX_SESSION_TOKEN";
    public static final String REDIS_CMS_KEY = "BAWX_CMS_TOKEN";
//    @Autowired private RedisConnectionFactory rcFactory;
   // @Resource
...
/*    @Override
    public void afterPropertiesSet() throws Exception {
        ...
        tt.setConnectionFactory(this.rcFactory);
        tt.afterPropertiesSet();
        this.redisTemplate = tt;
    }*/
}
