...
public class RetailOrderExcel {
    ...
    @ExcelColumn(valueKor = "합게",valueChn = "运费",col = 6)
    private String shippingCost;
    @ExcelColumn(valueKor = "예악자명",valueChn = "姓名",col = 7)
    private String custNm; //姓名 이름
    @ExcelColumn(valueKor = "배송주소",valueChn = "地址",col = 8)
    private String shippingAddrDetail; //配送地址 배송지
    @ExcelColumn(valueKor = "전화번호",valueChn = "手机号",col = 9)
    private String mobile; //手机号휴대폰 번호
    @ExcelColumn(valueKor = "상태",valueChn = "订单状态",col = 10)
    private String status; //状态
    @ExcelColumn(valueKor = "고객비고",valueChn = "备注",col = 11)
