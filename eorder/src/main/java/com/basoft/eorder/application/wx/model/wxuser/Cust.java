...
public class Cust {
	...
	public String toString() {
		return "Cust{" +
				...
				", wxIfOpenidP='" + wxIfOpenidP + '\'' +
				", email='" + email + '\'' +
				", mobileNo='" + mobileNo + '\'' +
				", wxIfIsSubscribe=" + wxIfIsSubscribe +
				", wxIfNickNm='" + wxIfNickNm + '\'' +
				", wxIfNickUnemoji='" + wxIfNickUnemoji + '\'' +
				", wxIfSexId=" + wxIfSexId +
				", wxIfLanguage='" + wxIfLanguage + '\'' +
				", wxIfCountryNm='" + wxIfCountryNm + '\'' +
				", wxIfProvinceNm='" + wxIfProvinceNm + '\'' +
				", wxIfCityNm='" + wxIfCityNm + '\'' +
				", wxIfHeadimgurl='" + wxIfHeadimgurl + '\'' +
				", wxIfSubscribeTime=" + wxIfSubscribeTime +
				", wxIfUnionid='" + wxIfUnionid + '\'' +
				", wxIfGroupid=" + wxIfGroupid +
				", wxIfRemark='" + wxIfRemark + '\'' +
				", wxSubscribeDt=" + wxSubscribeDt +
				", wxIdP='" + wxIdP + '\'' +
				", custNickNm='" + custNickNm + '\'' +
				", custRealNm='" + custRealNm + '\'' +
				", pwd='" + pwd + '\'' +
				", activeSts='" + activeSts + '\'' +
				", modifiedDt=" + modifiedDt +
				", createdDt=" + createdDt +
				", wxIfImgUrl='" + wxIfImgUrl + '\'' +
				", shopId=" + shopId +
				'}';
	}
}