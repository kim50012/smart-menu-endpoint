...
public class UserReturn extends WeixinReturn {
	...
	public String toString() {
		return "UserReturn [subscribe=" + subscribe + ", openid=" + openid + ", nickname=" + nickname + ", sex=" + sex
