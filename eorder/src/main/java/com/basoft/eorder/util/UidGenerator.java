...
//	@Value("${worker-id}")
	...
	@Autowired
	public UidGenerator(AppConfigure configure){
		this.regionId = (Long)configure.getObject(AppConfigure.BASOFT_REGION_ID_PROP).get();
		this.workerId = (Long)configure.getObject(AppConfigure.BASOFT_WORKER_ID_PROP).get();
