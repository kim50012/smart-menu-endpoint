...
public class SendRedPackResponse {
	...
	public String toString() {
		return "SendRedPackResponse [return_code=" + return_code + ", return_msg=" + return_msg + ", sign=" + sign
				...
				+ re_openid + ", total_amount=" + total_amount + ", send_listid=" + send_listid + ", send_time="
				+ send_time + "]";
	}
}